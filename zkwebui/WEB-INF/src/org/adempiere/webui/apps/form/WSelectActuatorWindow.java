...
public class WSelectActuatorWindow extends Window implements EventListener, WTableModelListener
{
	...
	public WSelectActuatorWindow(SelectActuator selectActuator, int windowNo)
	{
		super();
