...
/*	protected void loadOrder (int C_Order_ID, boolean forInvoice)
	...
	protected void loadTableOIS (Vector<?> data)
	{
		if(data.size() ==0)
		{
			//boolean respons = FDialog.ask(0,  null,"Tax is not updated on the order, Please revise the order to update the tax. (OR) Select a proper purchase category on the order.");
			//FDialog.error(0, window, "Tax is not updated on the order, Please revise the order to update the tax. (OR) Select a proper purchase category on the order.");
			boolean respon = FDialog.ask(1,  null," ","Tax is not updated on the order, Please revise the order to update the tax. (OR) Select a proper purchase category on the order.");
		}
