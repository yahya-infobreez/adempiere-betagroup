...
public class Process_GetStockInfo_OrderLine extends SvrProcess{
	...
	protected String doIt() throws Exception 
	{
		try {
		    	...
		    	String  prdSQL= "Select m_product_id FROM c_orderline where c_orderline_id=?";
		    	int prdID=DB.getSQLValue(get_TrxName(), prdSQL, Record_Id);
		    	
		    /*	String  warSQL= "Select m_warehouse_id FROM c_orderline where c_orderline_id=?";
		    	int warID=DB.getSQLValue(get_TrxName(), warSQL, Record_Id);  */
		    	...
		    	//System.out.println("SoVAL="+soVal);
		    	...
		    	//System.out.println("PO VAL="+poVal);
		    	...
		    	//String sqlUpd = "Update c_orderline set TxtStkInfo='" + txtStkInfo + "' Where c_orderline_id=?";
				/*try {
