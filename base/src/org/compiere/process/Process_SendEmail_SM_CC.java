...
public class Process_SendEmail_SM_CC extends SvrProcess {
    ...
    protected String doIt() throws Exception {
        ...
        String emailToSQL = "SELECT sm_email FROM c_projecttype WHERE c_projecttype_id = ?";
        ...
        String updateSQL = "UPDATE beta_custcomp SET cur_stat = 'W' WHERE beta_custcomp_id = ?";
