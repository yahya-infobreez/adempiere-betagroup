...
public final class EMail implements Serializable
{
	...
	public String send ()
	{
		...
		try
		{
			...
			//Modified By Subair on 18.02.2014
			//else if (m_smtpHost.equalsIgnoreCase("ex2010.myhostedservice.com"))
			else if (m_smtpHost.equalsIgnoreCase("smtp.office365.com"))  //Modified on Feb 13 2017
			{
				props.put("mail.smtp.port", "587");
				props.put("mail.smtp.starttls.enable", "true");
				props.put("mail.smtp.ssl.protocols","TLSv1.2");
			}
			//END Modified By Subair on 18.02.2014
