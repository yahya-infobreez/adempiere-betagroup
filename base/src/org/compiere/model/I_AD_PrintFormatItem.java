...
public interface I_AD_PrintFormatItem 
{
	...
	/** Set Calculate Variance (ÏƒÂ²).
	  * Calculate Variance
	  */
	public void setIsVarianceCalc (boolean IsVarianceCalc);

	/** Get Calculate Variance (ÏƒÂ²).
	  * Calculate Variance
	  */
