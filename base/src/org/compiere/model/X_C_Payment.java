...
// S
	...
	/** Set Receipt Book No.
		@param C_RECVOUCHERNO Receipt Book No	  */
	public void setC_RECVOUCHERNO (String C_RECVOUCHERNO)
	{
		set_Value (COLUMNNAME_C_RECVOUCHERNO, C_RECVOUCHERNO);
	}

	/** Get Receipt Book No.
		@return Receipt Book No	  */
	public String getC_RECVOUCHERNO () 
	{
		return (String)get_Value(COLUMNNAME_C_RECVOUCHERNO);
	}
