      ...
      /** if (C_Project_ID == 0)
        {
			...
			setDateContract (new Timestamp( System.currentTimeMillis() ));
...
// P
	...
	{
		if (C_QUOTATION_ID < 1) 
			set_Value (COLUMNNAME_C_QUOTATION_ID, null);
		else 
			set_Value (COLUMNNAME_C_QUOTATION_ID, Integer.valueOf(C_QUOTATION_ID));
	}
	...
	public I_C_Order getC_QUOTCAB() throws RuntimeException
    {
		return (I_C_Order)MTable.get(getCtx(), I_C_Order.Table_Name)
			.getPO(getC_QUOTCAB_ID(), get_TrxName());	}

	/** Set C_QUOTCAB_ID.
		@param C_QUOTCAB_ID C_QUOTCAB_ID	  */
	public void setC_QUOTCAB_ID (int C_QUOTCAB_ID)
	{
		if (C_QUOTCAB_ID < 1) 
			set_Value (COLUMNNAME_C_QUOTCAB_ID, null);
		else 
			set_Value (COLUMNNAME_C_QUOTCAB_ID, Integer.valueOf(C_QUOTCAB_ID));
	}

	/** Get C_QUOTCAB_ID.
		@return C_QUOTCAB_ID	  */
	public int getC_QUOTCAB_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_QUOTCAB_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Job Transaction List.
		@param JOBTRN Job Transaction List	  */
	public void setJOBTRN (String JOBTRN)
	{
		set_Value (COLUMNNAME_JOBTRN, JOBTRN);
	}

	/** Get Job Transaction List.
		@return Job Transaction List	  */
	public String getJOBTRN () 
	{
		return (String)get_Value(COLUMNNAME_JOBTRN);
	}
	...
	/** Set VOID_PROJECT.
		@param VOID_PROJECT VOID_PROJECT	  */
	public void setVOID_PROJECT (String VOID_PROJECT)
	{
		set_Value (COLUMNNAME_VOID_PROJECT, VOID_PROJECT);
	}

	/** Get VOID_PROJECT.
		@return VOID_PROJECT	  */
	public String getVOID_PROJECT () 
	{
		return (String)get_Value(COLUMNNAME_VOID_PROJECT);
	}
