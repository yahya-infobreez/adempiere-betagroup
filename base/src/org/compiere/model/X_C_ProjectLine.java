...
// N
	...
	/** Set Net Selling Price.
		@param NETSELLING_PRICE Net Selling Price	  */
	public void setNETSELLING_PRICE (BigDecimal NETSELLING_PRICE)
	{
		set_Value (COLUMNNAME_NETSELLING_PRICE, NETSELLING_PRICE);
	}

	/** Get Net Selling Price.
		@return Net Selling Price	  */
	public BigDecimal getNETSELLING_PRICE () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_NETSELLING_PRICE);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set PRICE_BEFORE_DISC.
		@param PRICE_BEFORE_DISC PRICE_BEFORE_DISC	  */
	public void setPRICE_BEFORE_DISC (BigDecimal PRICE_BEFORE_DISC)
	{
		set_Value (COLUMNNAME_PRICE_BEFORE_DISC, PRICE_BEFORE_DISC);
	}

	/** Get PRICE_BEFORE_DISC.
		@return PRICE_BEFORE_DISC	  */
	public BigDecimal getPRICE_BEFORE_DISC () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_PRICE_BEFORE_DISC);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
