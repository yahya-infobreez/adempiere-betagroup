...
public class MProjectLine extends X_C_ProjectLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		//Check Planned/Estimated Cost is Zero or Not ****** Dated 28Jul2011 ****
		BigDecimal EstAmt = getPlannedPrice();
		if (EstAmt.doubleValue() == 0)
		{
			log.saveError("Error", Msg.getMsg(getCtx(), "Estimated Cost for an item should not be Zero"));
			return false;
		}
