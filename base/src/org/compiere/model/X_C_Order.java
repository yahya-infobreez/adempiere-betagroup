...
// 5
	...
	/** Set Discount %.
		@param DISCPERC Discount %	  */
	public void setDISCPERC (BigDecimal DISCPERC)
	{
		set_Value (COLUMNNAME_DISCPERC, DISCPERC);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_DISCPERC);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Generate Order.
		@param GENORDER 
		Generate Order from Quotation
	  */
	public void setGENORDER (String GENORDER)
	{
		set_Value (COLUMNNAME_GENORDER, GENORDER);
	}

	/** Get Generate Order.
		@return Generate Order from Quotation
	  */
	public String getGENORDER () 
	{
		return (String)get_Value(COLUMNNAME_GENORDER);
	}

	/** Set Generate Project.
		@param GENPROJECT 
		Generate Project from Quotation
	  */
	public void setGENPROJECT (String GENPROJECT)
	{
		set_Value (COLUMNNAME_GENPROJECT, GENPROJECT);
	}

	/** Get Generate Project.
		@return Generate Project from Quotation
	  */
	public String getGENPROJECT () 
	{
		return (String)get_Value(COLUMNNAME_GENPROJECT);
	}
	...
	public I_C_Order getQUOT() throws RuntimeException
    {
		return (I_C_Order)MTable.get(getCtx(), I_C_Order.Table_Name)
			.getPO(getQUOT_ID(), get_TrxName());	}

	/** Set QUOT_ID.
		@param QUOT_ID QUOT_ID	  */
	public void setQUOT_ID (int QUOT_ID)
	{
		if (QUOT_ID < 1) 
			set_Value (COLUMNNAME_QUOT_ID, null);
		else 
			set_Value (COLUMNNAME_QUOT_ID, Integer.valueOf(QUOT_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_QUOT_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set QUOT_REF.
		@param QUOT_REF QUOT_REF	  */
	public void setQUOT_REF (String QUOT_REF)
	{
		set_Value (COLUMNNAME_QUOT_REF, QUOT_REF);
	}

	/** Get QUOT_REF.
		@return QUOT_REF	  */
	public String getQUOT_REF () 
	{
		return (String)get_Value(COLUMNNAME_QUOT_REF);
	}
	...
	public I_C_Order getSO() throws RuntimeException
    {
		return (I_C_Order)MTable.get(getCtx(), I_C_Order.Table_Name)
			.getPO(getSO_ID(), get_TrxName());	}
	...
	{
		if (SO_ID < 1) 
			set_Value (COLUMNNAME_SO_ID, null);
		else 
			set_Value (COLUMNNAME_SO_ID, Integer.valueOf(SO_ID));
	}
	...
	public int getSO_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_SO_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
