...
public class MClient extends X_AD_Client
{
	...
	//Added By Subair 
	public EMail createEMail (String from,String to, 
			String subject, String message, boolean html, String fromPWD)
		{
			...
			if (email == null)
				email = new EMail (this,
					   ...
					   subject, message, html);
			if (isSmtpAuthorization())
				email.createAuthenticator (from, fromPWD);
			return email;
		}
	//End of Added By Subair 
