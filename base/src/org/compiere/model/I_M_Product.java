...
public interface I_M_Product 
{
    ...
    /** Column name A_CELL_ADDR */
    public static final String COLUMNNAME_A_CELL_ADDR = "A_CELL_ADDR";
    ...
    /** Column name BETA_SUBCAT_ID */
    public static final String COLUMNNAME_BETA_SUBCAT_ID = "BETA_SUBCAT_ID";
    ...
    /** Column name B_CELL_ADDR */
    public static final String COLUMNNAME_B_CELL_ADDR = "B_CELL_ADDR";
    ...
    public static final String COLUMNNAME_EXCEL_FILE_NAME = "EXCEL_FILE_NAME";
    ...
    /** Column name FGCOST_CELL_ADDR */
    public static final String COLUMNNAME_FGCOST_CELL_ADDR = "FGCOST_CELL_ADDR";
    ...
    /** Column name FGTYPE */
    public static final String COLUMNNAME_FGTYPE = "FGTYPE";
    ...
    public static final String COLUMNNAME_LOCK_STATUS = "LOCK_STATUS";
    ...
    /** Column name RMCOST */
    public static final String COLUMNNAME_RMCOST = "RMCOST";
    ...
    /** Column name SUBGRP */
    public static final String COLUMNNAME_SUBGRP = "SUBGRP";
    ...
    /** Column name SUPPLYH_CELL_ADDR */
    public static final String COLUMNNAME_SUPPLYH_CELL_ADDR = "SUPPLYH_CELL_ADDR";
