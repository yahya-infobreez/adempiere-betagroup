...
// -
	...
	/** Set Price Factor.
		@param MARKUP_PCNT Price Factor	  */
	public void setMARKUP_PCNT (BigDecimal MARKUP_PCNT)
	{
		set_Value (COLUMNNAME_MARKUP_PCNT, MARKUP_PCNT);
	}

	/** Get Price Factor.
		@return Price Factor	  */
	public BigDecimal getMARKUP_PCNT () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_MARKUP_PCNT);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
