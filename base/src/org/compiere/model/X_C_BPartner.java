...
// N
	...
	/** Set Company Agent.
		@param ISCOMPAGENT Company Agent	  */
	public void setISCOMPAGENT (boolean ISCOMPAGENT)
	{
		set_Value (COLUMNNAME_ISCOMPAGENT, Boolean.valueOf(ISCOMPAGENT));
	}

	/** Get Company Agent.
		@return Company Agent	  */
	public boolean isCOMPAGENT () 
	{
		Object oo = get_Value(COLUMNNAME_ISCOMPAGENT);
		if (oo != null) 
		{
