...
// Y
	...
	/** GLLEVEL AD_Reference_ID=1000002 */
	public static final int GLLEVEL_AD_Reference_ID=1000002;
	/** 1 = 1 */
	public static final String GLLEVEL_1 = "1";
	/** 2 = 2 */
	public static final String GLLEVEL_2 = "2";
	/** 3 = 3 */
	public static final String GLLEVEL_3 = "3";
	/** 4 = 4 */
	public static final String GLLEVEL_4 = "4";
	/** 5 = 5 */
	public static final String GLLEVEL_5 = "5";
	/** Set GL Level.
		@param GLLEVEL GL Level	  */
	public void setGLLEVEL (String GLLEVEL)
	{

		set_Value (COLUMNNAME_GLLEVEL, GLLEVEL);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_GLLEVEL);
	}
