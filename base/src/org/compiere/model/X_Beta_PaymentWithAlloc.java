...
/** Generated Model for Beta_PaymentWithAlloc
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_Beta_PaymentWithAlloc extends PO implements I_Beta_PaymentWithAlloc, I_Persistent 
{
    ...
    public X_Beta_PaymentWithAlloc (Properties ctx, int Beta_PaymentWithAlloc_ID, String trxName)
    {
      super (ctx, Beta_PaymentWithAlloc_ID, trxName);
      /** if (Beta_PaymentWithAlloc_ID == 0)
        {
			setC_DocType_ID (0);
    ...
    /** Load Constructor */
    public X_Beta_PaymentWithAlloc (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Beta_PaymentWithAlloc[")
	...
	{
		set_Value (COLUMNNAME_BALAMT, BALAMT);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_BALAMT);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
