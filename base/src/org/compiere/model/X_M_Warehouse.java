...
// *
	...
	/** Set ISFGWAREHOUSE.
		@param ISFGWAREHOUSE ISFGWAREHOUSE	  */
	public void setISFGWAREHOUSE (boolean ISFGWAREHOUSE)
	{
		set_Value (COLUMNNAME_ISFGWAREHOUSE, Boolean.valueOf(ISFGWAREHOUSE));
	}

	/** Get ISFGWAREHOUSE.
		@return ISFGWAREHOUSE	  */
	public boolean isFGWAREHOUSE () 
	{
		Object oo = get_Value(COLUMNNAME_ISFGWAREHOUSE);
		if (oo != null) 
		{
