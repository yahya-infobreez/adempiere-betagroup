...
// I
	...
	/** Set A [Width] Cell.
		@param A_CELL_ADDR A [Width] Cell	  */
	public void setA_CELL_ADDR (String A_CELL_ADDR)
	{
		set_Value (COLUMNNAME_A_CELL_ADDR, A_CELL_ADDR);
	}

	/** Get A [Width] Cell.
		@return A [Width] Cell	  */
	public String getA_CELL_ADDR () 
	{
		return (String)get_Value(COLUMNNAME_A_CELL_ADDR);
	}

	public I_BETA_SUBCAT getBETA_SUBCAT() throws RuntimeException
    {
		return (I_BETA_SUBCAT)MTable.get(getCtx(), I_BETA_SUBCAT.Table_Name)
			.getPO(getBETA_SUBCAT_ID(), get_TrxName());	}

	/** Set Sub Category.
		@param BETA_SUBCAT_ID Sub Category	  */
	public void setBETA_SUBCAT_ID (int BETA_SUBCAT_ID)
	{
		if (BETA_SUBCAT_ID < 1) 
			set_Value (COLUMNNAME_BETA_SUBCAT_ID, null);
		else 
			set_Value (COLUMNNAME_BETA_SUBCAT_ID, Integer.valueOf(BETA_SUBCAT_ID));
	}

	/** Get Sub Category.
		@return Sub Category	  */
	public int getBETA_SUBCAT_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_BETA_SUBCAT_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set B [Height] Cell.
		@param B_CELL_ADDR B [Height] Cell	  */
	public void setB_CELL_ADDR (String B_CELL_ADDR)
	{
		set_Value (COLUMNNAME_B_CELL_ADDR, B_CELL_ADDR);
	}

	/** Get B [Height] Cell.
		@return B [Height] Cell	  */
	public String getB_CELL_ADDR () 
	{
		return (String)get_Value(COLUMNNAME_B_CELL_ADDR);
	}
	...
	{
		set_Value (COLUMNNAME_EXCEL_FILE_NAME, EXCEL_FILE_NAME);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_EXCEL_FILE_NAME);
	}

	/** Set FG Cost Cell.
		@param FGCOST_CELL_ADDR FG Cost Cell	  */
	public void setFGCOST_CELL_ADDR (String FGCOST_CELL_ADDR)
	{
		set_Value (COLUMNNAME_FGCOST_CELL_ADDR, FGCOST_CELL_ADDR);
	}

	/** Get FG Cost Cell.
		@return FG Cost Cell	  */
	public String getFGCOST_CELL_ADDR () 
	{
		return (String)get_Value(COLUMNNAME_FGCOST_CELL_ADDR);
	}

	/** FGTYPE AD_Reference_ID=1000003 */
	public static final int FGTYPE_AD_Reference_ID=1000003;
	/** STAINLESS STEEL = 05 */
	public static final String FGTYPE_STAINLESSSTEEL = "05";
	/** MISCELLANEOUS = 06 */
	public static final String FGTYPE_MISCELLANEOUS = "06";
	/** PERFORATES SHEETS = 08 */
	public static final String FGTYPE_PERFORATESSHEETS = "08";
	/** FINISHED ITEMS = 99 */
	public static final String FGTYPE_FINISHEDITEMS = "99";
	/** ALUMINIUM = 01 */
	public static final String FGTYPE_ALUMINIUM = "01";
	/** ELECTRIC GALVANIZ = 03 */
	public static final String FGTYPE_ELECTRICGALVANIZ = "03";
	/** GALVANIZED SHEET = 04 */
	public static final String FGTYPE_GALVANIZEDSHEET = "04";
	/** SPARE PARTS-FINNPOWER = 07 */
	public static final String FGTYPE_SPAREPARTS_FINNPOWER = "07";
	/** COLD ROLL = 02 */
	public static final String FGTYPE_COLDROLL = "02";
	/** MILD STEEL = 09 */
	public static final String FGTYPE_MILDSTEEL = "09";
	/** COLD ROLL = 10 */
	public static final String FGTYPE_COLDROLL1 = "10";
	/** METAL DOORS ACC = 11 */
	public static final String FGTYPE_METALDOORSACC = "11";
	/** ALWAN POWDER = 12 */
	public static final String FGTYPE_ALWANPOWDER = "12";
	/** CONSUMABLES = 13 */
	public static final String FGTYPE_CONSUMABLES = "13";
	/** DATA RACK ACC = 14 */
	public static final String FGTYPE_DATARACKACC = "14";
	/** MATE = 15 */
	public static final String FGTYPE_MATE = "15";
	/** TOOLS & DEMO-RYDTOOL = 201 */
	public static final String FGTYPE_TOOLSDEMO_RYDTOOL = "201";
	/** RESALE GOODS = 17 */
	public static final String FGTYPE_RESALEGOODS = "17";
	/** FI SALES GOODS = 101 */
	public static final String FGTYPE_FISALESGOODS = "101";
	/** RM STOCK (INTER.) = 102 */
	public static final String FGTYPE_RMSTOCKINTER = "102";
	/** IMAL SPAR PARTS = 18 */
	public static final String FGTYPE_IMALSPARPARTS = "18";
	/** SPAIR PARTS - POWDER = 20 */
	public static final String FGTYPE_SPAIRPARTS_POWDER = "20";
	/** SPARE PARTS - LASER = 21 */
	public static final String FGTYPE_SPAREPARTS_LASER = "21";
	/** SPARE PARTS-bystronic = 23 */
	public static final String FGTYPE_SPAREPARTS_Bystronic = "23";
	/** CANOPY ACC = 24 */
	public static final String FGTYPE_CANOPYACC = "24";
	/** TUBES = 25 */
	public static final String FGTYPE_TUBES = "25";
	/** HARDWARE = 26 */
	public static final String FGTYPE_HARDWARE = "26";
	/** GRILLS = 27 */
	public static final String FGTYPE_GRILLS = "27";
	/** CABINET - FINISH = 50 */
	public static final String FGTYPE_CABINET_FINISH = "50";
	/** Set Sub Category.
		@param FGTYPE Sub Category	  */
	public void setFGTYPE (String FGTYPE)
	{

		set_Value (COLUMNNAME_FGTYPE, FGTYPE);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_FGTYPE);
	}
	...
	/** Set Lock Status.
		@param LOCK_STATUS Lock Status	  */
	public void setLOCK_STATUS (boolean LOCK_STATUS)
	{
		set_Value (COLUMNNAME_LOCK_STATUS, Boolean.valueOf(LOCK_STATUS));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_LOCK_STATUS);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Raw Mat. Cost.
		@param RMCOST Raw Mat. Cost	  */
	public void setRMCOST (BigDecimal RMCOST)
	{
		set_Value (COLUMNNAME_RMCOST, RMCOST);
	}

	/** Get Raw Mat. Cost.
		@return Raw Mat. Cost	  */
	public BigDecimal getRMCOST () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_RMCOST);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** SUBGRP AD_Reference_ID=1000021 */
	public static final int SUBGRP_AD_Reference_ID=1000021;
	/** LEAVES = L */
	public static final String SUBGRP_LEAVES = "L";
	/** FRAMES = F */
	public static final String SUBGRP_FRAMES = "F";
	/** NONE = N */
	public static final String SUBGRP_NONE = "N";
	/** Set Sub Group.
		@param SUBGRP Sub Group	  */
	public void setSUBGRP (String SUBGRP)
	{

		set_Value (COLUMNNAME_SUBGRP, SUBGRP);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_SUBGRP);
	}

	/** Set Supply/H Cell.
		@param SUPPLYH_CELL_ADDR Supply/H Cell	  */
	public void setSUPPLYH_CELL_ADDR (String SUPPLYH_CELL_ADDR)
	{
		set_Value (COLUMNNAME_SUPPLYH_CELL_ADDR, SUPPLYH_CELL_ADDR);
	}

	/** Get Supply/H Cell.
		@return Supply/H Cell	  */
	public String getSUPPLYH_CELL_ADDR () 
	{
		return (String)get_Value(COLUMNNAME_SUPPLYH_CELL_ADDR);
	}
