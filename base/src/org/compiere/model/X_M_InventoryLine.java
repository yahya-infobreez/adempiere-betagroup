...
// @M_Locator_ID@
	...
	//**Added 29.10.2017
	public void setIOCLINE_ID (int IOCLINE_ID)
	{
		if (IOCLINE_ID < 1) 
			set_Value (COLUMNNAME_IOCLINE_ID, null);
		else 
			set_Value (COLUMNNAME_IOCLINE_ID, Integer.valueOf(IOCLINE_ID));
	}
	public int getIOCLINE_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_IOCLINE_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
