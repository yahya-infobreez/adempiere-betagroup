...
/** Generated Model for C_ProjectReceipt
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_C_ProjectReceipt extends PO implements I_C_ProjectReceipt, I_Persistent 
{
    ...
    public X_C_ProjectReceipt (Properties ctx, int C_ProjectReceipt_ID, String trxName)
    {
      super (ctx, C_ProjectReceipt_ID, trxName);
      /** if (C_ProjectReceipt_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_C_ProjectReceipt (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_ProjectReceipt[")
